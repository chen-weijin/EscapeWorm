System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, director, StorageManager, Logger, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, Main;
    ...
    execute: function () {
      ...
      _export("Main", Main = (_dec = ccclass('Main'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class Main extends Component {
        ...
        onOpenSettings() {
          (_crd && Logger === void 0 ? (_reportPossibleCrUseOfLogger({
            error: Error()
          }), Logger) : Logger).log('打开设置'); // TODO: 显示设置面板
        }
...
//# sourceMappingURL=9e2f6fec680789d7ff4aee0e754df12423bbf7dd.js.map