System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, director, Vec2, Vec3, UITransform, Graphics, Color, Label, Sprite, SpriteFrame, resources, Input, Worm, PathFinder, CollisionDetector, LevelManager, StorageManager, AudioManager, EffectManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, GameController;
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property([Node]), _dec6 = property(Node), _dec(_class = (_class2 = class GameController extends Component {
        ...
        renderWormSegments(wormNode, worm, segments, visibleCount) {
          ...
          for (let i = 0; i < segments.length; i++) {
            ...
            if (i === 0 && !isVisible && !worm.hasEscaped()) {// console.warn(`警告：蠕虫 ${worm.id} 头部被隐藏！segments.length=${segments.length}, visibleCount=${visibleCount}, isVisible=${isVisible}`);
            }
            ...
            if (i === 0) {
              ...
              if (transform) {
                ...
                if (Math.abs(screenPos.x) > halfWidth * 2 || Math.abs(screenPos.y) > halfHeight * 2) {//console.warn(`警告：蠕虫 ${worm.id} 头部坐标超出屏幕范围！world=(${segment.x}, ${segment.y}) screen=(${screenPos.x.toFixed(0)}, ${screenPos.y.toFixed(0)}), 屏幕范围=(${halfWidth}, ${halfHeight})`);
                }
              }
            } // 绘制段
        ...
        showResult(isVictory) {
          console.log(isVictory ? '胜利！' : '失败！'); // 查找 GameSceneController 并调用其 showResult 方法
          ...
          if (sceneController && typeof sceneController.showResult === 'function') {
            ...
            console.error('未找到 GameSceneController，无法显示结果');
          }
        }
        /**
         * 更新 UI
...
//# sourceMappingURL=fc0f19dc58b29c0a79c62d5b984013290bc8b07b.js.map