    ...
    execute: function () {
      ...
      _export("Worm", Worm = (_dec = ccclass('Worm'), _dec(_class = (_class2 = class Worm extends Component {
            ...
            try {
              ...
              setTimeout(() => {
                try {
                  ...
                  this.completeAnimation(); //console.log(`蠕虫 ${this.id} 动画完成，resolve`);
        ...
        reset() {
          ...
          } // console.log(`蠕虫 ${this.id} reset完成: segments=${this.segments.length}, visibleCount=${this.visibleSegmentCount}, 头部=(${this.segments[0]?.x}, ${this.segments[0]?.y})`);
...
//# sourceMappingURL=6606f82096ff53f4cb24c816d9ee53321c8719c6.js.map