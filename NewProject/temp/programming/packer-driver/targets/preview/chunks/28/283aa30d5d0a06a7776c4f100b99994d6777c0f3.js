      ...
      _export("ResultController", ResultController = (_dec = ccclass('ResultController'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class ResultController extends Component {
        ...
        setupUI() {
          ...
          if (this.backgroundNode) {
            var graphics = this.backgroundNode.getComponent(Graphics) || this.backgroundNode.addComponent(Graphics);
            var transform = this.backgroundNode.getComponent(UITransform);
        ...
        onNextClick() {
          ...
          var nextLevel = this.levelId + 1; // 查找 GameSceneController

          var sceneController = this.findGameSceneController();
        ...
        findGameSceneController() {
          ...
          while (parent) {
            var sceneController = parent.getComponent('GameSceneController');
...
//# sourceMappingURL=283aa30d5d0a06a7776c4f100b99994d6777c0f3.js.map