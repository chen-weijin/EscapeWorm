      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property([Node]), _dec6 = property(Node), _dec(_class = (_class2 = class GameController extends Component {
        ...
        showResult(isVictory) {
          ...
          if (this.gameSceneController) {
            var sceneController = this.gameSceneController.getComponent('GameSceneController');
            ...
            while (parent) {
              var _sceneController = parent.getComponent('GameSceneController');

              if (_sceneController && typeof _sceneController.showResult === 'function') {
                _sceneController.showResult(isVictory, this.currentLevelId);
...
//# sourceMappingURL=3cbbab7198e8cffa938550872f9acfcf3e9d5c3b.js.map