      ...
      _export("CollisionDetector", CollisionDetector = class CollisionDetector {
        ...
        static checkCollision(worm, newPosition, allWorms) {
          for (var otherWorm of allWorms) {
            ...
            for (var segment of otherWorm.segments) {
        ...
        static willCollide(worm, allWorms) {
          ...
          var nextPosition = new Vec2(headPos.x + direction.x, headPos.y + direction.y);
        ...
        static isPositionOccupied(position, allWorms, excludeWormId) {
          if (excludeWormId === void 0) {
            excludeWormId = null;
          }

          for (var worm of allWorms) {
...
//# sourceMappingURL=a232c631bc8370bfde05a10ecdc3739e389766f9.js.map