System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec2, Logger, _dec, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, Worm;
      ...
      _export("Worm", Worm = (_dec = ccclass('Worm'), _dec(_class = (_class2 = class Worm extends Component {
            ...
            try {
              ...
              if (this.isEscaped) {
                (_crd && Logger === void 0 ? (_reportPossibleCrUseOfLogger({
                  error: Error()
                }), Logger) : Logger).log("\u8815\u866B " + this.id + " \u5DF2\u9003\u8131\uFF0C\u8DF3\u8FC7\u52A8\u753B");
                resolve();
                return;
              }
              ...
              (_crd && Logger === void 0 ? (_reportPossibleCrUseOfLogger({
                error: Error()
              }), Logger) : Logger).log("\u8815\u866B " + this.id + " \u5F00\u59CB\u79FB\u52A8\u52A8\u753B: \u4ECE (" + ((_this$segments$ = this.segments[0]) == null ? void 0 : _this$segments$.x) + ", " + ((_this$segments$2 = this.segments[0]) == null ? void 0 : _this$segments$2.y) + ") \u5230 (" + newHeadPosition.x + ", " + newHeadPosition.y + "), \u6301\u7EED\u65F6\u95F4=" + duration + "ms"); // 保存当前位置作为动画起始位置
              ...
              setTimeout(() => {
                try {
                  ...
                  this.completeAnimation(); //Logger.log(`蠕虫 ${this.id} 动画完成，resolve`);

                  resolve();
                } catch (error) {
                  (_crd && Logger === void 0 ? (_reportPossibleCrUseOfLogger({
                    error: Error()
                  }), Logger) : Logger).error("\u8815\u866B " + this.id + " \u52A8\u753B\u5B8C\u6210\u56DE\u8C03\u4E2D\u53D1\u751F\u9519\u8BEF:", error);
                  reject(error);
                }
              }, duration);
            } catch (error) {
              (_crd && Logger === void 0 ? (_reportPossibleCrUseOfLogger({
                error: Error()
              }), Logger) : Logger).error("\u8815\u866B " + this.id + " startMoveAnimation \u4E2D\u53D1\u751F\u9519\u8BEF:", error);
              reject(error);
            }
          });
        }
        ...
        reset() {
          ...
          if (this.originalSegments.length === 0) {
            (_crd && Logger === void 0 ? (_reportPossibleCrUseOfLogger({
              error: Error()
            }), Logger) : Logger).error("\u9519\u8BEF\uFF1A\u8815\u866B " + this.id + " \u7684 originalSegments \u4E3A\u7A7A\uFF01\u65E0\u6CD5\u91CD\u7F6E\uFF01");
            return;
          }
          ...
          if (this.segments.length === 0) {
            (_crd && Logger === void 0 ? (_reportPossibleCrUseOfLogger({
              error: Error()
            }), Logger) : Logger).error("\u9519\u8BEF\uFF1A\u8815\u866B " + this.id + " reset \u540E segments \u4E3A\u7A7A\uFF01");
          }

          if (this.visibleSegmentCount === 0) {
            (_crd && Logger === void 0 ? (_reportPossibleCrUseOfLogger({
              error: Error()
            }), Logger) : Logger).error("\u9519\u8BEF\uFF1A\u8815\u866B " + this.id + " reset \u540E visibleSegmentCount=0\uFF01");
...
//# sourceMappingURL=5f0d43e7b0d0c01abddd6907ee144b2b2b14ef1b.js.map