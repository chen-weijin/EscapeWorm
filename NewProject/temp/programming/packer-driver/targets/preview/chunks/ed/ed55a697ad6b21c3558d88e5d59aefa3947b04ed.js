      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property([Node]), _dec(_class = (_class2 = class GameController extends Component {
        ...
        initLevel(levelId) {
          ...
          return _asyncToGenerator(function* () {
            ...
            try {
              ...
              yield _this2.animateWormsAppearance();
            } catch (error) {
        ...
        renderWormSegments(wormNode, worm, segments, visibleCount) {
          ...
          while (wormNode.children.length < segments.length) {
            var segmentNode = new Node("Segment_" + wormNode.children.length);
            segmentNode.parent = wormNode; // 先添加 UITransform（如果不存在）

            if (!segmentNode.getComponent(UITransform)) {
              segmentNode.addComponent(UITransform);
            } // 添加 Graphics 组件用于绘制（如果不存在）


            if (!segmentNode.getComponent(Graphics)) {
          ...
          for (var i = 0; i < segments.length; i++) {
            ...
            var graphics = _segmentNode.getComponent(Graphics);
...
//# sourceMappingURL=ed55a697ad6b21c3558d88e5d59aefa3947b04ed.js.map