      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property([Node]), _dec(_class = (_class2 = class GameController extends Component {
            ...
            try {
              ...
              var _loop = function* _loop() {
                ...
                var isOutOfBounds = !(_crd && CollisionDetector === void 0 ? (_reportPossibleCrUseOfCollisionDetector({
                  error: Error()
                }), CollisionDetector) : CollisionDetector).isInBounds(nextPos, _this5.matrix.width, _this5.matrix.height); // 检查是否在逃脱点上

                var isOnEscapePoint = _this5.escapePoints.some(ep => ep.x === nextPos.x && ep.y === nextPos.y);
              ...
              var isFinalOnEscapePoint = _this5.escapePoints.some(ep => ep.x === finalPos.x && ep.y === finalPos.y);
        ...
        tryMoveWormOneStep(worm) {
          ...
          return _asyncToGenerator(function* () {
            ...
            var isOutOfBounds = !(_crd && CollisionDetector === void 0 ? (_reportPossibleCrUseOfCollisionDetector({
              error: Error()
            }), CollisionDetector) : CollisionDetector).isInBounds(nextPos, _this7.matrix.width, _this7.matrix.height); // 检查是否在逃脱点上

            var isOnEscapePoint = _this7.escapePoints.some(ep => ep.x === nextPos.x && ep.y === nextPos.y);
...
//# sourceMappingURL=5e33bf103b9e3bdb9500a92d6fe4dd9e6baecebf.js.map