System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, sys, _dec, _class, _crd, ccclass, property, StorageManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("StorageManager", StorageManager = (_dec = ccclass('StorageManager'), _dec(_class = class StorageManager extends Component {
        ...
        getUnlockedLevels() {
          try {
            var data = sys.localStorage.getItem(this.UNLOCKED_LEVELS);
        ...
        getCompletedLevels() {
          try {
            var data = sys.localStorage.getItem(this.COMPLETED_LEVELS);
            return data ? JSON.parse(data) : [];
          } catch (e) {
        ...
        getCurrentLevel() {
          try {
            var data = sys.localStorage.getItem(this.CURRENT_LEVEL);
        ...
        getSettings() {
          try {
            var data = sys.localStorage.getItem(this.SETTINGS);
            return data ? JSON.parse(data) : {
              musicEnabled: true,
              soundEnabled: true
            };
...
//# sourceMappingURL=df21f36558843faf2a05d5270df89f374936e22d.js.map