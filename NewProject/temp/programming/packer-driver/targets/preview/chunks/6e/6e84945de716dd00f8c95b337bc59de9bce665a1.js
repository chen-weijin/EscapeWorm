System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Label, Color, director, UITransform, Graphics, Vec3, Input, StorageManager, AudioManager, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, MenuController;
    ...
    execute: function () {
      ...
      _export("MenuController", MenuController = (_dec = ccclass('MenuController'), _dec2 = property(Node), _dec3 = property(Label), _dec(_class = (_class2 = class MenuController extends Component {
        ...
        createLevelButton(level, x, y) {
          ...
          var radius = this.cellSize / 2 - 20; // 绘制按钮背景
        ...
        onTouchEnd(event) {
          ...
          if (!transform) return;
          var localPos = transform.convertToNodeSpaceAR(new Vec3(location.x, location.y, 0)); // 检查点击的关卡
        ...
        onLevelClick(level) {
          ...
          if (level.unlocked) {
            ...
            console.log("\u5F00\u59CB\u5173\u5361 " + level.id); // 保存当前关卡并切换场景
...
//# sourceMappingURL=6e84945de716dd00f8c95b337bc59de9bce665a1.js.map