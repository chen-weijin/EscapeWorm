System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Label, Color, director, Graphics, Vec3, tween, GameController, StorageManager, ResultController, Logger, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _crd, ccclass, property, GameSceneController;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameSceneController", GameSceneController = (_dec = ccclass('GameSceneController'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property([Node]), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Label), _dec10 = property(Node), _dec11 = property(Slider), _dec(_class = (_class2 = class GameSceneController extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "scaleSlider", _descriptor10, this);
      ...
      }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "scaleSlider", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=d6f6f311c61e06dcab37b684f6a71c8297acbff1.js.map