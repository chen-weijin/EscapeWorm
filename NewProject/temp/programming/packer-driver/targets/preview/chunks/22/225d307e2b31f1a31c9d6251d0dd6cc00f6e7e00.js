  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property([Node]), _dec(_class = (_class2 = class GameController extends Component {
         ...
         */
        setupGameArea() {
          if (!this.gameArea || this.gameAreaSetup) return; // 创建 Graphics 组件用于绘制网格
          ...
          console.log('触摸事件已注册到 gameArea, size=', transform == null ? void 0 : transform.width, 'x', transform == null ? void 0 : transform.height);
...
//# sourceMappingURL=225d307e2b31f1a31c9d6251d0dd6cc00f6e7e00.js.map